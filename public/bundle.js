...
/***/ function(module, exports, __webpack_require__) {
	...
	var Operator = __webpack_require__(182);
						...
						React.createElement(
							...
							React.createElement(
								...
								numbers.map(function (number) {
									return React.createElement(Number, { number: number, click: this.setNumber });
								}.bind(this)),
								React.createElement('br', null),
								React.createElement(Operator, { operator: '+', click: this.setOperator }),
								React.createElement(Operator, { operator: '/', click: this.setOperator }),
								React.createElement(Operator, { operator: '*', click: this.setOperator }),
								React.createElement(Operator, { operator: '%', click: this.setOperator }),
								React.createElement('br', null),
								React.createElement(
									'button',
									{ className: 'btn btn-success number', onClick: this.calculate },
									'='
								)
							)
						)
					),
					React.createElement(Results, { num1: this.state.num1, num2: this.state.num2, operator: this.state.operator, result: this.state.result })
				)
			);
		}
	});
	...
	var Number = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"button",
					{ className: "btn btn-primary number", onClick: this.handleClick, value: this.props.number },
					this.props.number
				)
			);
		}
	...
	var Operator = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"button",
					{ className: "btn btn-danger operator", onClick: this.handleOperator, value: this.props.operator },
					this.props.operator
				)
			);
		}
